...
def get_write_text(textval, pdf_filename=None) -> None:
    ...
    # 匹配月缴基数
    month_patterns = [
        r'月交保险费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年交保险费',
        r'月交保费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年交保费',
        r'月交保险费\s*[=＝\s]\s*年交保险费\s*[*＊×xX]\s*([0-9.]+)',
        r'月交保费\s*[=＝\s]\s*年交保费\s*[*＊×xX]\s*([0-9.]+)',
        r'月交保险费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年化保险费',
        r'月交保费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年化保费',
        r'月交保险费\s*[=＝\s]\s*年化保险费\s*[*＊×xX]\s*([0-9.]+)',
        r'月交保费\s*[=＝\s]\s*年化保费\s*[*＊×xX]\s*([0-9.]+)',
        r'月交[0-9,，]+元保险费对应的基本保险金额[=＝\s]\s*年交[0-9,，]+元保险费对应的基本保险金额\s*÷\s*([0-9.]+)',
        r'月交[0-9,，]+元保险费对应的基本保险金额[=＝\s]\s*年交[0-9,，]+元保险费对应的基本保险金额([0-9.]+)',
    ]
    ...
    # 匹配季缴基数
    quarter_patterns = [
        r'季交保险费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年交保险费',
        r'季交保费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年交保费',
        r'季交保险费\s*[=＝\s]\s*年交保险费\s*[*＊×xX]\s*([0-9.]+)',
        r'季交保费\s*[=＝\s]\s*年交保费\s*[*＊×xX]\s*([0-9.]+)',
        r'季交保险费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年化保险费',
        r'季交保费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年化保费',
        r'季交保险费\s*[=＝\s]\s*年化保险费\s*[*＊×xX]\s*([0-9.]+)',
        r'季交保费\s*[=＝\s]\s*年化保费\s*[*＊×xX]\s*([0-9.]+)',
        r'季交[0-9,，]+元保险费对应的基本保险金额[=＝\s]\s*年交[0-9,，]+元保险费对应的基本保险金额\s*÷\s*([0-9.]+)',
        r'季交[0-9,，]+元保险费对应的基本保险金额[=＝\s]\s*年交[0-9,，]+元保险费对应的基本保险金额([0-9.]+)',
    ]
    ...
    # 匹配半年缴基数
    half_year_patterns = [
        r'半年交保险费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年交保险费',
        r'半年交保费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年交保费',
        r'半年交保险费\s*[=＝\s]\s*年交保险费\s*[*＊×xX]\s*([0-9.]+)',
        r'半年交保费\s*[=＝\s]\s*年交保费\s*[*＊×xX]\s*([0-9.]+)',
        r'半年交保险费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年化保险费',
        r'半年交保费\s*[=＝\s]\s*([0-9.]+)\s*[*＊×xX]\s*年化保费',
        r'半年交保险费\s*[=＝\s]\s*年化保险费\s*[*＊×xX]\s*([0-9.]+)',
        r'半年交保费\s*[=＝\s]\s*年化保费\s*[*＊×xX]\s*([0-9.]+)',
        r'半年交[0-9,，]+元保险费对应的基本保险金额[=＝\s]\s*年交[0-9,，]+元保险费对应的基本保险金额\s*÷\s*([0-9.]+)',
        r'半年交[0-9,，]+元保险费对应的基本保险金额[=＝\s]\s*年交[0-9,，]+元保险费对应的基本保险金额([0-9.]+)',
    ]
